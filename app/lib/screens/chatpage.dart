...
class ChatPage extends StatefulWidget {
  ...
  ChatPage({required this.name, required this.user_id, required this.match_id});
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (BuildContext context,
                  ...
                  if (snapshot.hasData) {
                    List<dynamic> type = snapshot.data as List<dynamic>;
                    if (type.isEmpty) {
                      return Container();
                    }
                    if (type[0]['type'] == "Homeowner") {
                      return Container(
                          child: Row(
                        ...
                        children: [
                          OutlinedButton(
                              onPressed: () async {
                                ...
                                String url = "http://10.0.2.2:3000/reject";
                          ...
                          OutlinedButton(
                              onPressed: () async {
                                ...
                                String url = "http://10.0.2.2:3000/accept";
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                                ...
                                children: const [
                                  Text('Pending approval from homeowner...')
                                ]),
                          ],
                        ),
                      );
