...
class RejectChatPage extends StatefulWidget {
  final String name;
  final int user_id;
  final int match_id;
  ...
  @override
  _RejectChatPageState createState() => _RejectChatPageState();
}

class _RejectChatPageState extends State<RejectChatPage> {
        ...
        body: Column(
          children: [
            ...
            Container(
                child: const Center(
              child: Text(
                  'Unfortunately the homeowner doesn\'t think its a match',
                ...
                children: [
                  const Expanded(
                    child: Padding(
                        ...
                        child: Text('Cannot send messages')),
                  ),
                  IconButton(
